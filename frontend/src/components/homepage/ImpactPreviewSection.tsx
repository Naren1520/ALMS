    ...
    <section className="py-24 md:py-32 bg-ivory-dark border-t border-border font-sans text-charcoal">
      <div className="container">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#FA7A21]/15 border border-[#FA7A21]/30 rounded-full mb-4">
            <ShieldCheck size={14} className="text-[#FA7A21]" />
            <span
              className="font-sans font-semibold text-gold-dark text-xs uppercase tracking-wider"
          ...
          <p className="text-stone text-sm sm:text-base leading-relaxed max-w-2xl mx-auto font-light">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          {/* Before ALMS */}
          <div className="bg-ivory border border-red-200/60 p-6 sm:p-8 shadow-xs space-y-4" style={{ borderRadius: '28px' }}>
            <div className="flex items-center justify-between pb-3 border-b border-border">
              <h3 className="font-serif text-xl font-medium text-red-900">Before ALMS (Status Quo)</h3>
              <span className="text-xs px-3 py-1 bg-red-100 text-red-700 font-semibold" style={{ borderRadius: '999px' }}>High Friction</span>
            </div>
          ...
          {/* After ALMS */}
          <div className="bg-ivory border border-green-300/80 p-6 sm:p-8 shadow-sm space-y-4 relative overflow-hidden" style={{ borderRadius: '28px' }}>
            ...
            <div className="flex items-center justify-between pb-3 border-b border-border">
              ...
              <span className="text-xs px-3 py-1 bg-green-100 text-green-800 font-semibold" style={{ borderRadius: '999px' }}>Empowered</span>
            </div>
        ...
        <div className="text-center">
          <Link
            href="/impact"
            className="px-8 py-3.5 bg-[#FA7A21] hover:bg-[#e06917] text-white font-sans font-semibold text-xs rounded-full shadow-md hover:shadow-lg transition-all duration-200 inline-flex items-center gap-2"
          >
